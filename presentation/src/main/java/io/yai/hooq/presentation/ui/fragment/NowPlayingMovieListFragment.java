...
import io.yai.hooq.presentation.ui.adapter.NowPlayingMoviesAdapter;

public class NowPlayingMovieListFragment extends BaseFragment implements MovieListView {

    public static final String TAG = NowPlayingMovieListFragment.class.getSimpleName();
    ...
    private NowPlayingMoviesAdapter adapter;
    private MovieListPresenter presenter;
    private GridLayoutManager gridLayoutManager;

    private List<MovieModel> movies;
    private NowPlayingMoviesPresenter nowPlayingMoviesPresenter;

    public static NowPlayingMovieListFragment newInstance(List<MovieModel> movies) {

        NowPlayingMovieListFragment fragment = new NowPlayingMovieListFragment();
    ...
    public void setSearchMoviesPresenter(NowPlayingMoviesPresenter nowPlayingMoviesPresenter) {
        this.nowPlayingMoviesPresenter = nowPlayingMoviesPresenter;
    }
    ...
    public NowPlayingMoviesAdapter getAdapter(){
        return adapter;
    }
    ...
    public void configureGUI() {
        ...
        adapter = new NowPlayingMoviesAdapter(getActivity());
                ...
                new RecyclerView.OnScrollListener() {
                    ...
                    public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                        ...
                        if (!recyclerView.canScrollVertically(1)) {
                            page++;
                            nowPlayingMoviesPresenter.performGetNowPlaying(page);
                        }
                    }
                }
        );
